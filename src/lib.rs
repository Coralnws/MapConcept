...
#[derive(Debug)]
pub struct MapConceptProcessor {
    verbose: bool,
    processed_count: usize,
}

impl MapConceptProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting MapConcept processing");
    
    let mut processor = MapConceptProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = MapConceptProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = MapConceptProcessor::new(false);
